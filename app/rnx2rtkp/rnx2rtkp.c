...
int main(int argc, char **argv)
{
    ...
    if (prcopt.DSM.processing_type != 0) {
        ...
        prcopt.DSM.rejection_threshold = 0.99; // Reject sats with more than 50% probability of obstruction
        ...
        prcopt.DSM.max_noise_scaling = 40; // Scale errors to a max of 20 times
