...
typedef struct DSMData {
    ...
    int processing_type; /*
                         -4 = Calculate true psuedorange and probability and use reference satellite selection and use max prob (must do this before a positive option to set truth, all negative numbers must have truth hardcoded in postpos)
                         ...
                         6 = 9 but with combining probabilities
                         ...
                         10 = 9 but no reference sat selection
                         11 = 9 but rejection instead of deweighting
                         12 = 9 but no height based change rejection, use whatever
                         13 = 9 but search radius limited to x?
...
extern int out_of_bounds_check(int x_steps, int y_steps, DSMData* DSM);
